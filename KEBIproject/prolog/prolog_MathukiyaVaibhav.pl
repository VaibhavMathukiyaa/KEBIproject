...
ingredient(mushrooms,lactose_free,gluten_free,vegetarian).
...
ingredient(vongole,lactose_free,gluten_free,vegetarian).
...
meal("Vegetable_Pizza", [flour, water, salt, oil, mozzarella, eggplant, onion, zucchini, carrot, tomato, champignon], medium).
...
meal("Tiramisu", [ladyfinger, coffee, mascarpone], high).
meal("Macedonia", [peach, apple, strawberry, sugar, lemon], low).
meal("Tartare", [salt, salmon, avocado, lemon, tomato], high).
meal("Arancini_al_ragu", [bread, flour, rice, salt, water, mozzarella, onion, beef, oil, tomato_sauce], high).
meal("Vegetarian_arancini", [bread, flour, rice, salt, water, mozzarella, onion, oil, tomato_sauce], medium).
...
meal("Vegetarian_ravioli", [pecorino, ricotta, salt, flour, egg, onion, tomato_sauce, oil], medium).
